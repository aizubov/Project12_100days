...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        topScore = userDefaults.object(forKey: tsKey) as? Int ?? 0
        print("current top score", topScore)
    ...
    func gameOver() {
        ...
        var message = "Your score is \(scoreFinal)"
        
        if score > topScore {
            message += "\n\nNew Highest Score\nPrevious highest: \(topScore)"
            topScore = score
        }
        ...
        //saveTopScore()
        let userDefaults = UserDefaults.standard
        userDefaults.set(topScore, forKey: tsKey)
